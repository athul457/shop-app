...
import { ShoppingCart, User, Search, LogOut, Package, MapPin, Heart, Settings, ShoppingBag } from 'lucide-react';
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  // Only navigate if we are on a page that supports search, or redirect to products
                  // For simplicity, we'll keep the existing logic but ensure it points to the right dashboard root
                  const basePath = user?.role === 'admin' ? '/admin/products' : '/dashboard';
